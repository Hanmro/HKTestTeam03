...
WebUI.setText(findTestObject('Login Page/Page_TestProject Demo/input_Full Name_name'), 'hkit')

WebUI.setEncryptedText(findTestObject('Login Page/Page_TestProject Demo/input_Password_password'), 'iGDxf8hSRT4=')
